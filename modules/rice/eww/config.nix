...
in
{
  home.file.".config/eww/eww.yuck".text = ''
                  ...
                  (defpoll SONG :interval "1s" `/home/${config.home.username}/.config/eww/scripts/music.sh --song`)
                  (defpoll ARTIST :interval "1s" `/home/${config.home.username}/.config/eww/scripts/music.sh --artist`)
                  (defpoll STATUS :interval "0.5s" `/home/${config.home.username}/.config/eww/scripts/music.sh --status`)
                  (defpoll CURRENT :interval "1s" `/home/${config.home.username}/.config/eww/scripts/music.sh --time`)
                  (defpoll COVER :interval "1s" `/home/${config.home.username}/.config/eww/scripts/music.sh --cover`)
                  (defpoll CTIME :interval "1s" `/home/${config.home.username}/.config/eww/scripts/music.sh --ctime`)
                  (defpoll TTIME :interval "1s" `/home/${config.home.username}/.config/eww/scripts/music.sh --ttime`)
                  (defpoll LYRICS :interval "0.5s" `/home/${config.home.username}/.config/eww/scripts/lyrics.py`)
                  ...
                  (defpoll host :interval "86400s" "echo ${config.home.username}@$(cat /etc/hostname)")
                    ...
                    (box
                      ...
                      (box
                        ...
                        (eventbox
                          ...
                          :valign "canter"
                          :cursor "hand2"
                          :onclick "/home/${config.home.username}/.config/eww/scripts/do-calendar-action reset"
                          (box ""))
                        (box
                          ...
                          (eventbox
                            ...
                            :valign "fill"
                            :cursor "hand2"
                            :onclick "/home/${config.home.username}/.config/eww/scripts/do-calendar-action month_up"
                            :onscroll "/home/${config.home.username}/.config/eww/scripts/do-calendar-action month_{}"
                            (box :valign "end" ""))
                          (eventbox
                            :class "month"
                            :halign "center"
                          ...
                          (eventbox
                            ...
                            :valign "fill"
                            :cursor "hand2"
                            :onclick "/home/${config.home.username}/.config/eww/scripts/do-calendar-action month_down"
                            :onscroll "/home/${config.home.username}/.config/eww/scripts/do-calendar-action month_{}"
                            (box :valign "start" "")))
                        (box
                          :class "controls-year"
                          ...
                          (eventbox
                            ...
                            :valign "fill"
                            :cursor "hand2"
                            :onclick "/home/${config.home.username}/.config/eww/scripts/do-calendar-action year_up"
                            :onscroll "/home/${config.home.username}/.config/eww/scripts/do-calendar-action year_{}"
                            (box :valign "end" ""))
                          (eventbox
                            :class "year"
                            :halign "center"
                          ...
                          (eventbox
                            ...
                            :valign "fill"
                            :cursor "hand2"
                            :onclick "/home/${config.home.username}/.config/eww/scripts/do-calendar-action year_down"
                            :onscroll "/home/${config.home.username}/.config/eww/scripts/do-calendar-action year_{}"
                            (box :valign "start" ""))))
                      (calendar-custom
                        :hexpand true)))
            	  ...
            	  :width 500
                      (box
                        ...
                        :hexpand true
                        :vexpand false
                        (label :class "host" :xalign 0 :text host)
                      ...
                      (box :class "start-inner-box" :orientation "h" :space-evenly "false" :vexpand "false" :hexpand "false"
                        ...
                        (box :orientation "v" :spacing 5 :space-evenly "false" :vexpand "false" :hexpand "false"
                          ...
                          (box :orientation "h" :spacing 10 :halign "center" :space-evenly "true" :vexpand "false" :hexpand "false"
                            (button :class "btn_prev" :onclick "/home/${config.home.username}/.config/eww/scripts/music.sh --prev" "󰒮")
                            (button :class "btn_play" :onclick "/home/${config.home.username}/.config/eww/scripts/music.sh --toggle" STATUS)
                            (button :class "btn_next" :onclick "/home/${config.home.username}/.config/eww/scripts/music.sh --next" "󰒭"))
